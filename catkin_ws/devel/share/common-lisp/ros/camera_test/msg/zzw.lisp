...
(cl:defmethod cl:initialize-instance :after ((m <zzw>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'zzw)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_test-msg:<zzw> is deprecated: use camera_test-msg:zzw instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <zzw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_test-msg:header-val is deprecated.  Use camera_test-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <zzw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_test-msg:pose-val is deprecated.  Use camera_test-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <zzw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_test-msg:id-val is deprecated.  Use camera_test-msg:id instead.")
  (id m))
